...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    checkAvailability(venue, date) {
      var t1, t2, t3, events, isAvailable, _i, $event, outputElement,
      ...
      if (storedEvents != null) {
        ...
        events = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("Map<String,String>(1)")._as(new A.checkAvailability_closure()), t3), true, t3._eval$1("ListIterable.E"));
        t1 = events.length;
        _i = 0;
        while (true) {
          if (!(_i < t1)) {
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      A.checkAvailability(selectedVenue, selectedDate == null ? "" : selectedDate);
    },
    $signature: 3
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.checkAvailability_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.DivElement, A.FormElement, A.InputElement, A.SelectElement]);
...
//# sourceMappingURL=availability.dart.js.map
