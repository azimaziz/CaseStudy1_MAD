...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Duration$(days) {
      return new A.Duration(864e8 * days);
    },
    ...
    main() {
      ...
      A._EventStreamSubscription$(type$.FormElement._as(document.querySelector("#availabilityForm")), "submit", t1._eval$1("~(1)?")._as(new A.main_closure()), false, t1._precomputed1);
    },
    checkAvailability(venue, date) {
      var t1, events, isAvailable, _i, $event, t2, outputElement,
        storedEvents = window.localStorage.getItem("events");
      if (storedEvents != null) {
        t1 = J.map$1$1$ax(type$.List_dynamic._as(B.C_JsonCodec.decode$1(0, storedEvents)), new A.checkAvailability_closure(), type$.Map_String_String);
        events = A.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E"));
        t1 = events.length;
        _i = 0;
        while (true) {
          if (!(_i < t1)) {
          ...
          $event = events[_i];
          t2 = J.getInterceptor$ax($event);
          if (J.$eq$(t2.$index($event, "eventVenue"), venue) && J.$eq$(t2.$index($event, "date"), date)) {
            isAvailable = false;
            break;
          }
          ++_i;
        ...
        isAvailable = true;
      outputElement = type$.DivElement._as(document.querySelector("#availabilityOutput"));
      t1 = "The venue " + venue;
      if (isAvailable)
        B.DivElement_methods.set$text(outputElement, t1 + " is available on " + date + ".");
      else {
        B.DivElement_methods.set$text(outputElement, t1 + " is booked on " + date + ".");
        A.loadEvents(venue, date);
      }
    },
    clearTable() {
      var i, t3, t4, t5,
        t1 = document,
        t2 = type$.TableElement._as(t1.querySelector(".centered-table")).rows;
      for (i = t2.length - 1, t3 = type$.TableRowElement; i >= 1; --i) {
        if (!(i < t2.length))
          return A.ioore(t2, i);
        t4 = t3._as(t2[i]);
        t5 = t4.parentNode;
        if (t5 != null)
          t5.removeChild(t4).toString;
      }
      B.DivElement_methods.set$text(type$.DivElement._as(t1.querySelector("#suggestText")), "");
    },
    loadEvents(venue, date) {
      var i, t1, t2, t3;
      B.DivElement_methods.set$text(type$.DivElement._as(document.querySelector("#suggestText")), "These are the schedule for venue " + venue + " 3 days before & after " + date + ".");
      for (i = 3; i >= 1; --i) {
        t1 = A.DateTime_parse(date);
        t2 = t1._value - B.JSInt_methods._tdivFast$1(A.Duration$(i)._duration, 1000);
        t1 = t1.isUtc;
        t3 = new A.DateTime(t2, t1);
        t3.DateTime$_withValue$2$isUtc(t2, t1);
        A.buildTable(venue, t3.toString$0(0));
      }
      for (i = 1; i <= 3; ++i) {
        t1 = A.DateTime_parse(date);
        t2 = t1._value + B.JSInt_methods._tdivFast$1(A.Duration$(i)._duration, 1000);
    ...
    buildTable(venue, newDate) {
      var t1, events, t2, isAvailable, _i, $event, t3, t4, t5, row, _s4_ = "date",
        _s10_ = "eventVenue",
        storedEvents = window.localStorage.getItem("events"),
        table = type$.TableElement._as(document.querySelector(".centered-table"));
      if (storedEvents != null) {
        t1 = J.map$1$1$ax(type$.List_dynamic._as(B.C_JsonCodec.decode$1(0, storedEvents)), new A.buildTable_closure(), type$.Map_String_String);
        events = A.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E"));
        for (t1 = events.length, t2 = type$.TableCellElement, isAvailable = false, _i = 0; _i < t1; ++_i) {
          $event = events[_i];
          t3 = J.getInterceptor$ax($event);
          A.printString(A.S(t3.$index($event, _s4_)));
          A.printString(newDate);
          if (J.$eq$(t3.$index($event, _s10_), venue)) {
            t4 = t3.$index($event, _s4_);
            t4.toString;
            t4 = A.DateTime_parse(t4);
            t5 = A.DateTime_parse(newDate);
            if (t4._value === t5._value && t4.isUtc === t5.isUtc) {
              row = B.TableElement_methods._insertRow$1(table, -1);
              t4 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
              t5 = t3.$index($event, "personName");
              B.TableCellElement_methods.set$text(t4, t5 == null ? "" : t5);
              t4 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
              t5 = t3.$index($event, "eventName");
              B.TableCellElement_methods.set$text(t4, t5 == null ? "" : t5);
              t4 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
              t5 = t3.$index($event, _s10_);
              B.TableCellElement_methods.set$text(t4, t5 == null ? "" : t5);
              t4 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
              t5 = t3.$index($event, _s4_);
              B.TableCellElement_methods.set$text(t4, t5 == null ? "" : t5);
              t4 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
              t3 = t3.$index($event, "time");
              B.TableCellElement_methods.set$text(t4, t3 == null ? "" : t3);
              isAvailable = true;
            }
          }
        }
        if (!isAvailable) {
          row = B.TableElement_methods._insertRow$1(table, -1);
          B.TableCellElement_methods.set$text(t2._as(B.TableRowElement_methods._insertCell$1(row, -1)), "  -  ");
          B.TableCellElement_methods.set$text(t2._as(B.TableRowElement_methods._insertCell$1(row, -1)), "Date Available");
          t1 = t2._as(B.TableRowElement_methods._insertCell$1(row, -1));
          B.TableCellElement_methods.set$text(t1, venue);
          B.TableCellElement_methods.set$text(t2._as(B.TableRowElement_methods._insertCell$1(row, -1)), A.abbrevBad(newDate));
          B.TableCellElement_methods.set$text(t2._as(B.TableRowElement_methods._insertCell$1(row, -1)), "  -  ");
        }
      }
    },
    abbrevBad(input) {
      if (input.length <= 10)
        return input;
      return B.JSString_methods.substring$2(input, 0, 10);
    },
    main_closure: function main_closure() {
    },
    checkAvailability_closure: function checkAvailability_closure() {
    },
    buildTable_closure: function buildTable_closure() {
    },
    printString(string) {
  ...
  A.TableElement.prototype = {
    _insertRow$1(receiver, index) {
      var t1 = receiver.insertRow(index);
      t1.toString;
      return t1;
    },
    $isTableElement: 1
  ...
  A.TableRowElement.prototype = {
    _insertCell$1(receiver, index) {
      var t1 = receiver.insertCell(index);
      t1.toString;
      return t1;
    },
    $isTableRowElement: 1
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var t1, selectedVenue, selectedDate;
      e.preventDefault();
      t1 = document;
      selectedVenue = type$.SelectElement._as(t1.querySelector("#venue")).value;
      if (selectedVenue == null)
        selectedVenue = "";
      selectedDate = type$.InputElement._as(t1.querySelector("#date")).value;
      if (selectedDate == null)
        selectedDate = "";
      A.clearTable();
      A.checkAvailability(selectedVenue, selectedDate);
    },
    $signature: 4
  };
  A.checkAvailability_closure.prototype = {
    call$1(e) {
      var t1 = type$.String;
      return A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(e), t1, t1);
    },
    $signature: 5
  };
  A.buildTable_closure.prototype = {
    call$1(e) {
      var t1 = type$.String;
      return A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(e), t1, t1);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.ListBase, A.Codec, A.Converter, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A._WrappedIterator, A.FixedSizeListIterator]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A._Storage_JavaScriptObject_MapMixin]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.DivElement, A.FormElement, A.InputElement, A.SelectElement, A.TableCellElement, A.TableElement, A.TableRowElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null()", "int(String?)", "~(Event)", "Map<String,String>(@)", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(@,@)", "~(Object?,Object?)", "~(String,String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"RegExp":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"List":["1"],"Iterable":["1"]},"MapBase":{"Map":["1","2"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonCodec":{"Codec":["Object?","String"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Node":{"EventTarget":[]},"TableRowElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"Storage":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"TableCellElement":{"Element":[],"Node":[],"EventTarget":[]},"TableElement":{"Element":[],"Node":[],"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_WrappedList":{"ListBase":["1"],"List":["1"],"Iterable":["1"],"ListBase.E":"1"},"_WrappedIterator":{"Iterator":["1"]},"FixedSizeListIterator":{"Iterator":["1"]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      TableElement: findType("TableElement"),
  ...
  (function constants() {
    ...
    B.TableRowElement_methods = A.TableRowElement.prototype;
...
//# sourceMappingURL=check_availability.dart.js.map
