// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.1.4.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      A._EventStreamSubscription$(type$.FormElement._as(document.querySelector("#cancelEventForm")), "submit", t1._eval$1("~(1)?")._as(new A.main_closure()), false, t1._precomputed1);
    },
    cancelEvent(personName, date) {
      ...
      if (storedEvents != null) {
        ...
        events = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("Map<String,String>(1)")._as(new A.cancelEvent_closure()), t3), true, t3._eval$1("ListIterable.E"));
        t3 = A._arrayInstanceType(events)._eval$1("bool(1)")._as(new A.cancelEvent_closure0(personName, date));
        if (!!events.fixed$length)
          A.throwExpression(A.UnsupportedError$("removeWhere"));
        B.JSArray_methods._removeWhere$2(events, t3, true);
    ...
    cancelEvent_closure: function cancelEvent_closure() {
    },
    cancelEvent_closure0: function cancelEvent_closure0(t0, t1) {
      this.personName = t0;
      this.date = t1;
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var t1, t2, personName, date;
      e.preventDefault();
      t1 = document;
      t2 = type$.InputElement;
      personName = t2._as(t1.querySelector("#personName")).value;
      if (personName == null)
        personName = "";
      date = t2._as(t1.querySelector("#date")).value;
      A.cancelEvent(personName, date == null ? "" : date);
    },
    $signature: 5
  };
  A.cancelEvent_closure.prototype = {
    call$1(e) {
      var t1 = type$.String;
  ...
  A.cancelEvent_closure0.prototype = {
    call$1($event) {
      var t1;
      type$.Map_String_String._as($event);
      t1 = J.getInterceptor$ax($event);
      return J.$eq$(t1.$index($event, "personName"), this.personName) && J.$eq$(t1.$index($event, "date"), this.date);
    },
    $signature: 14
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.cancelEvent_closure, A.cancelEvent_closure0]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "@(@)", "Null()", "~(Object?,Object?)", "~(Event)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(@,@)", "~(String,String)", "Map<String,String>(@)", "bool(Map<String,String>)"],
...
//# sourceMappingURL=cancel_event.dart.js.map
